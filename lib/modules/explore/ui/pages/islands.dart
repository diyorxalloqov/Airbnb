          ...
          child: Stack(
            ...
            children: [
              ListView.builder(
                  ...
                  itemCount:
                      (context.read<ExploreBloc>().state.productsModel.length) +
                          1,
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    const SpaceHeight(),
                                    const Text(
                                      "When you see a Guest Favourite, you'll know it's one of the 2 miilion most loved homes on airbnb___.",
                                      textAlign: TextAlign.center,
                                      style: TextStyle(
                                        fontSize: 20,
                                      ),
