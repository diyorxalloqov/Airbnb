...
class SmallGoogleMaps extends StatefulWidget {
  const SmallGoogleMaps({super.key});

  @override
  State<SmallGoogleMaps> createState() => MapSampleState();
}

class MapSampleState extends State<SmallGoogleMaps> {
