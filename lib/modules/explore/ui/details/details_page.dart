...
import 'package:airbnb___/modules/explore/ui/details/details_page_details.dart/all_amenits.dart';
import 'package:airbnb___/modules/explore/ui/widgets/page_view_widget_details.dart';
import 'package:airbnb___/modules/explore/ui/widgets/small_google_map.dart';
...
class DetailsPage extends StatelessWidget {
  ...
  const DetailsPage({super.key, required this.index, required this.state});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: [
            ImagePageView(index: index, state: state),
            Padding(
              padding:
                  ...
                  ElevatedButton(
                      onPressed: () {
                        Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (context) =>
                                    AmenitsPage(state: state,index:index)));
                      },
                    ...
                    children: [
                      ...
                      const Stack(
                        ...
                        children: [
                          CircleAvatar(
                            backgroundImage: NetworkImage(
                                'https://a0.muscache.com/im/Portrait/Avatars/messaging/b3e03835-ade9-4eb7-a0bb-2466ab9a534d.jpg?im_policy=medq_w_text&im_t=R&im_w=240&im_f=airbnb___-cereal-medium.ttf&im_c=ffffff'),
                          ),
                          Positioned(
                              left: 25,
                              child: Icon(
